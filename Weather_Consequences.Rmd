...
output: 
  html_document: 
    ...
    keep_md: yes
---
*NOTE:  rmarkdown::render('Weather Event Consequences.Rmd', clean = FALSE)* to knit
...
kable(c(InjSums[1:10,],FatSums[1:10,]), caption = "Table showing top 10 event types for total injuries and fatalities")
...
```{r resultsEcon}
kable(sdd2[sdd3DamInd[1:10,2:5]],caption = "Table showing to economic damages, in dollars.")
```